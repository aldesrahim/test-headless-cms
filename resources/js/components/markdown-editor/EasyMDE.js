/**
 * Source: https://github.com/filamentphp/filament/blob/3.x/packages/forms/resources/js/components/markdown-editor/EasyMDE.js
 */
        ...
        if (form) {
            ...
            if (index !== -1) {
                for (let i = index - 1; i >= 0; i--) {
                    ...
                    if (element && element.tagName === 'INPUT' && !element.closest('.editor-toolbar')) {
                        element.focus();
                        break;
                    }
                }
